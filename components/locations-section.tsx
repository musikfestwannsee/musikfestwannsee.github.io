    ...
    <section id="locations" className="py-24 water-bg">
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          <h2 className="section-title centered">Veranstaltungsorte</h2>
        </div>
...
const otherLocations = [
  {
    ...
    anfahrt: 'Bus 118, 318 | Haltestelle Wilhelmplatz | 140 m Fußweg',
  ...
  },
  {
    ...
    anfahrt: 'Bus 316 | Haltestelle Nikolskoer Weg | 1500 m Fußweg (ca. 20 min.)\n' +
  ...
  },
  {
    ...
    address: 'Lindenstraße 2, 14109 Berlin',
    anfahrt: 'Bus 118, 218, 316 | Haltestelle Pfaueninselchaussee/Königstr. | 800 m Fußweg (ca. 12 min.)\n' +
